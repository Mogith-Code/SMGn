...
import disasterIcon from '../assets/images/flood_24dp_D69E2E_FILL0_wght400_GRAD0_opsz24.svg';
import announcementIcon from '../assets/images/brand_awareness_24dp_D69E2E_FILL0_wght400_GRAD0_opsz24.svg';
import arrowIcon from '../assets/images/arrow_forward_24dp_2D3748_FILL0_wght400_GRAD0_opsz24.svg';
...
function Services() {
  ...
  const handleApplyForAllowances = () => {
        ...
        <div className="w-full grid grid-cols-3 gap-5 max-lg:grid-cols-2 max-md:grid-cols-1">
          ...
          >
            ...
            <div className="flex justify-between items-center gap-2">
              ...
              {/* Arrow Icon - Now just visual, not the only clickable element */}
              <img 
                src={arrowIcon}
                alt="Arrow icon"
          ...
          {/* ============================================================== */}
          {/* CARD 4: Apply for Allowances - Entire Card Clickable */}
          {/* ============================================================== */}
          <div 
            onClick={handleApplyForAllowances}
            role="button"
            tabIndex={0}
            onKeyDown={(e) => {
              if (e.key === 'Enter' || e.key === ' ') {
                handleApplyForAllowances();
              }
            }}
            className="flex flex-col p-[30px] rounded-[25px] bg-white shadow-[0_10px_25px_rgba(0,0,0,0.1)] justify-center hover:shadow-[0_20px_35px_rgba(0,0,0,0.15)] hover:scale-[1.02] transition-all duration-300 group cursor-pointer"
          >
          ...
          {/* ============================================================== */}
          {/* CARD 5: Disaster Relief - Entire Card Clickable */}
          {/* ============================================================== */}
          <div 
          ...
          {/* ============================================================== */}
          {/* CARD 6: Announcements - Entire Card Clickable */}
          {/* ============================================================== */}
          <div 
